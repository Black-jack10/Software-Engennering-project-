...
if (isset($_POST['submit'])){
  ...
  $wardenNumber=$_POST['WardenNumber'];
  $Username=$_POST['Username'];
  $query = $conn->query("insert into warden_(Firstname_,Surname_,password_,Username_,WardenNumber_) values('$firstname','$LastName','$password','$Username',$wardenNumber)");
    ...
    <main>
      ...
      <!--<div class="row">
        ...
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3"> Warden Registration details</h4>
          <form class="needs-validation" novalidate method="post">
            ...
            <div class="mb-3">
              <label for="student Number">warden Number<span class="text-muted"></span></label>
              <input type="number" class="form-control" id="number" placeholder="202003639" name="WardenNumber">
              <div class="invalid-feedback">
